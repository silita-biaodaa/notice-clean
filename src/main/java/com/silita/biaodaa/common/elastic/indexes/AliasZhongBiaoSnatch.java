 ...
 */
@Document(indexName = "bdd_zhongbiao_18_04_11", type = "zhongbiao_snatch", shards = 4, replicas = 1, refreshInterval = "1")
public class AliasZhongBiaoSnatch extends ElasticEntity {
