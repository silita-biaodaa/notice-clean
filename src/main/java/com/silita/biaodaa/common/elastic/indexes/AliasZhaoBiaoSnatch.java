 ...
 * Company: silita
 * Author: gemingyi
 * Date: 2018-08-01:16:21
 */
@Document(indexName = "bdd_zhaobiao_18_03-30", type = "zhaobiao_snatch", shards = 4, replicas = 1, refreshInterval = "1")
public class AliasZhaoBiaoSnatch extends ElasticEntity {
